 ...
 * tell what type and content it is). After encryption it will be enclosed in {@link SessionEncryptedExchange} and send to server.
 ...
 * {@link SessionEncryptedExchange} add it to {@link GlobalClient} sending queue <br>
