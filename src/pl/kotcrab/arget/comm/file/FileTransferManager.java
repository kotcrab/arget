...
import pl.kotcrab.arget.server.session.gui.FileTransferMessage;
import pl.kotcrab.arget.server.session.gui.FileTransferMessageAdapter;
import pl.kotcrab.arget.server.session.gui.FileTransferMessageListener;
import pl.kotcrab.arget.server.session.gui.ImageMessage;
